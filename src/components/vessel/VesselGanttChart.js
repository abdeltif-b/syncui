...
export const VesselGanttChart = () => {
	...
	const templateRight = (props) => RightLabelTemplate(props);
	...
	return (<div className='control-pane'>
		<div className='control-section'>
			...
			>
				<ColumnsDirective>
					<ColumnDirective field='id' width='55' allowFiltering={false} allowEditing={false}></ColumnDirective>
