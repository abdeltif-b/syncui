...
const VesselUnload = () => {
  ...
  return (
    <>
      ...
      >
        <ColumnsDirective>
          <ColumnDirective field="Navire" width="120" textAlign="Center"></ColumnDirective>
          <ColumnDirective field="Numéro du conteneur" width="120" textAlign="Center" isPrimaryKey></ColumnDirective>
          <ColumnDirective
            field="Type du conteneur"
            width="120"
            textAlign="Center"
            allowEditing={true}
          ></ColumnDirective>
          <ColumnDirective
            field="Section transversale (BAY)"
            width="120"
            textAlign="Center"
            allowEditing={true}
          ></ColumnDirective>
