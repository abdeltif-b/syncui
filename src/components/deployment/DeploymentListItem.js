						...
						<div className="flex align-items-center flex-wrap">
							...
							<div className="ml-5 flex align-items-center text-700 flex-wrap">
								...
								<div className="mr-5 flex align-items-center mt-1">
									...
									<span>
										{item.arrival_date ? item.arrival_date : <span title="Date de départ prévue" className='text-red-600 border-none border-dotted border-bottom-1'>{item.expected_arrival_date}</span>}
										<FontAwesomeIcon icon={faArrowRight} className="mx-2" size='xs' />
										{item.departure_date ? item.departure_date : <span title="Date de départ prévue" className='text-red-600 border-none border-dotted border-bottom-1'>{item.expected_departure_date}</span>}
									</span>
								</div>
